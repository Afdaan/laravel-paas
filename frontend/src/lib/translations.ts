  ...
  en: {
    ...
    billing: {
      ...
      admin: {
        ...
        addCreditsForUserDescription: "Add credits to another user or admin's wallet by user ID.",
  ...
  id: {
    ...
    billing: {
      ...
      admin: {
        ...
        addCreditsForUserDescription: "Tambahkan kredit ke wallet user atau admin lain berdasarkan user ID.",
