export const translations = {
  en: {
    ...
    billing: {
      ...
      officialInvoiceTitle: "Invoice Receipt",
      electronicDocDisclaimer: "Electronically generated billing receipt.",
      ...
      cancelTopup: "Cancel",
      paymentSecurityTitle: "Secure Provider Checkout",
  ...
  id: {
    ...
    billing: {
      ...
      cancelTopup: "Batal",
      paymentSecurityTitle: "Pembayaran Aman Provider",
     ...
     currentPeriod: "Periode berjalan: {{start}} sampai {{end}}",
      ...
      issuerInfo: "Penerbit",
      officialInvoiceTitle: "Bukti Tagihan",
      electronicDocDisclaimer: "Bukti pembayaran diterbitkan secara elektronik.",
