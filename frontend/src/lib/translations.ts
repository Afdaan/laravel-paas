  ...
  id: {
    ...
    admin: {
      ...
      queue: {
        ...
        cancel: "Batalkan",
        confirmCancel: "Yakin ingin membatalkan proses deployment ini?",
        cancelSuccess: "Deployment berhasil dibatalkan",
        cancelError: "Gagal membatalkan deployment",
        confirmRequeue: "Yakin ingin memaksa antre ulang job ini?",
    ...
    domains: {
      transfer: "Transfer Domain",
      transferDesc: "Pindahkan domain ini ke project lain. Seluruh traffic akan langsung dialihkan ke project tujuan.",
      selectTarget: "Pilih Target Project",
      transferAction: "Mulai Transfer",
      transferSuccess: "Domain berhasil dialihkan ke target project",
      confirmDelete: "Apakah Anda yakin ingin menghapus domain ini?",
      noDomains: "Custom domain tidak ditemukan",
      noDomainsDesc: "Belum ada custom domain yang terhubung. Tambahkan custom domain baru melalui pengaturan project.",
      ...
      errors: {
        ...
        CERTBOT_TIMEOUT: "Certbot Timeout: Waktu verifikasi tantangan (challenge) ACME Certbot telah habis.",
      ...
      events: {
        title: "Log Audit Rekonsiliasi",
        desc: "Riwayat kronologis seluruh transisi status domain dan event challenge Let's Encrypt.",
        event: "Event",
        transition: "Transisi Status",
        timestamp: "Timestamp",
        noEvents: "Belum ada event audit yang tercatat untuk domain ini.",
        configHash: "Hash Konfigurasi Nginx Aktif",
      },
    },
    projectDetail: {
      metrics: {
      ...
      settings: {
        ...
        noCustomDomain: "Tidak ada domain kustom yang terdaftar",
        addDomainPrompt: "Tambahkan domain kustom untuk mengakses proyek Anda melalui alamat URL pilihan Anda.",
      },
      overview: {
