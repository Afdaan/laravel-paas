export const translations = {
  en: {
    ...
    databaseStudio: {
      ...
      structure: {
        ...
        guidelinesTitle: "Designer Guidelines",
        guidelinesDesc: "Visual migrations automatically map and format standard SQL statements. All updates generated are instantly evaluated. GORM schema reconciliation triggers automatically to synchronize ORM metadata tables safely.",
      ...
      backups: {
        ...
        desc: "Point-in-time database snapshot backups catalog",
        ...
        catalogCapacity: "Catalog Capacity:",
        snapshotsLabel: "snapshots",
        sreRetentionNote: "Creating a 6th snapshot automatically deletes the oldest completed backup archive.",
        sreRetentionTitle: "SRE Pruning Retention",
        sreRetentionDesc: "The catalog operates a strict 5-backup FIFO auto-pruning queue. Generating a 6th snapshot will automatically delete the oldest backup file on disk.",
        actions: {
          download: "Download",
          restore: "Restore",
          prune: "Prune"
  ...
  id: {
    ...
    databaseStudio: {
      ...
      errors: {
        connectFailed: "Gagal terhubung ke Managed Database. Verifikasi bahwa proyek sedang berjalan.",
        readRowsFailed: "Gagal membaca baris tabel.",
        rotateFailed: "Gagal merotasi kredensial.",
        testConnectionFailed: "Uji coba restart koneksi gagal",
        updateStatusFailed: "Gagal memperbarui status.",
        createBackupFailed: "Gagal membuat cadangan snapshot.",
        restoreBackupFailed: "Gagal memulihkan snapshot.",
        deleteBackupFailed: "Gagal memotong cadangan.",
        downloadBackupFailed: "Gagal mengunduh cadangan snapshot.",
        missingPrimaryKey: "Nilai primary key hilang.",
        deleteRowFailed: "Gagal menghapus baris.",
        designerActionFailed: "Aksi visual desainer gagal."
      },
      overview: {
        title: "Database Studio",
        subtitle: "Sumber Daya Tenant Terisolasi & Desainer Skema DDL",
        suspendedWarning: "Tidak ada akses database. Database ditangguhkan.",
        suspendedTitle: "Instance Database Ditangguhkan",
        suspendedDesc: "Hak koneksi telah dicabut secara aktif dan seluruh koneksi backend aktif telah diputus secara paksa untuk mengamankan sumber daya. Mulai ulang atau aktifkan kembali instance untuk memulihkan akses data penuh.",
        connecting: "Menghubungkan ke Managed Database Studio...",
        confirmRotate: "Apakah Anda benar-benar yakin ingin merotasi kredensial? Ini akan memicu dimulainya kembali lingkungan hot-swap instan tanpa downtime.",
        confirmSuspend: "Tangguhkan database? Ini mencabut hak koneksi dan memutuskan seluruh koneksi tenant yang aktif secara paksa saat ini juga.",
        confirmResume: "Aktifkan kembali database? Ini memulihkan akses koneksi.",
        metrics: {
          engine: "Mesin",
          status: "Status",
          realtime: "Real-time",
          activeConnections: "Koneksi Aktif",
          activeConnectionsSub: "Jumlah aplikasi aktif yang terhubung ke database ini",
          connectionsLimitDesc: "Batas ketat 15 koneksi diterapkan per tenant untuk menjamin perlindungan DoS kluster.",
          storageUsage: "Penggunaan Penyimpanan",
          storageUsageSub: "Alokasi disk database tenant",
          storageLimitDesc: "Volume terkelola mencegah kelaparan ruang disk sistem host bersama.",
          tablesCount: "Jumlah Tabel",
          version: "Versi",
          diskUsed: "Disk Digunakan",
          tables: "Tabel",
          resourceUsageTitle: "Metrik Penggunaan Sumber Daya"
        },
        actions: {
          syncState: "Sinkronkan Status",
          testConnection: "Uji Koneksi",
          rotateCredentials: "Rotasi Password",
          suspendDatabase: "Tangguhkan DB",
        ...
        credentials: {
          title: "Kredensial Koneksi",
          subtitle: "Kredensial internal untuk pengikatan koneksi kontainer proyek",
          host: "Host",
          port: "Port",
          databaseName: "Nama Database",
          username: "Username",
          password: "Password",
          reveal: "Tampilkan Password",
          hide: "Sembunyikan Password"
        },
        autoBackup: {
          title: "Auto Backup (Pro)",
          desc: "Backup Harian otomatis dijadwalkan pada tengah malam.",
          enabled: "Aktif (Harian pada 00:00)",
          disabled: "Nonaktif"
        },
        snapshotLimit: {
          title: "Batas File Snapshot",
          desc: "Batas file snapshot cadangan database aktif di katalog retensi.",
          freeLimit: "5 Snapshot (Batas Gratis)",
          proLimit: "50 Snapshot (Batas Pro)",
          manageConfig: "Kelola Konfigurasi Snapshot",
          manageConfigSub: "Klik untuk mengonfigurasi pengaturan snapshot, batas, dan jadwal otomatis."
        },
        sre: {
          title: "Isolasi Tenant SRE",
          portMapping: "Pemetaan Port:",
          portMappingDesc: "PostgreSQL terisolasi mendengarkan pada port host 5433, MySQL terisolasi pada 3306.",
          dosCap: "Batas DoS:",
          dosCapDesc: "Menerapkan batas penyingkatan koneksi sebanyak 15 thread database simultan per tenant.",
          queryTimeouts: "Timeout Kueri:",
          queryTimeoutsDesc: "Semua kueri SQL mentah dievaluasi di bawah batas waktu eksekusi CPU kontekstual 15 detik yang ketat.",
          auditLogs: "Log Audit:",
          auditLogsDesc: "Pembaruan desainer DDL visual menulis jejak audit anti-rusak yang memetakan alamat IP pengguna."
        }
      },
      tables: {
        sidebarTitle: "Tabel Database",
        sidebarDesc: "Pilih atau buat tabel untuk memeriksa skema dan menjalankan mutasi visual.",
        ...
        deleteRowConfirmDesc: "Apakah Anda yakin ingin menghapus baris data ini?",
        deleteRowAction: "Hapus Baris",
        noTablesFound: "Tabel tidak ditemukan",
        noMatches: "Tidak ada yang cocok",
        tableDesc: "Jelajahi baris data secara visual dan hapus baris dengan aman tanpa SQL",
        showingRows: "Menampilkan {{start}} - {{end}} dari {{total}} baris",
        loadingRows: "Memuat Baris Tabel...",
        deleteRowSuccess: "Baris dihapus dengan aman."
      },
      structure: {
        ...
        subtitle: "Perancangan skema visual langsung, menulis penanda log audit",
        noSchemaObjects: "Database tidak memiliki objek skema",
        noSchemaObjectsDesc: "Skema tabel belum dideklarasikan. Klik tombol Buat Tabel untuk memulai pemodelan skema visual.",
        guidelinesTitle: "Panduan Desainer",
        guidelinesDesc: "Migrasi visual secara otomatis memetakan dan memformat pernyataan SQL standar. Semua pembaruan yang dihasilkan langsung dievaluasi. Rekonsiliasi skema GORM dipicu secara otomatis untuk menyinkronkan tabel metadata ORM dengan aman.",
        ...
        createTableDialog: {
          title: "Dialog Buat Tabel",
          desc: "Tentukan struktur tabel baru dan kolom dinamis Anda.",
          tableName: "Nama Tabel",
          tableNamePlaceholder: "misal. posts",
          autoDesignWarning: "Desain otomatis: Struktur GORM memerlukan primary key. Kunci integer auto-increment id akan ditambahkan secara otomatis.",
          columnsDefinition: "Definisi Kolom",
        ...
        addColumnDialog: {
          title: "Dialog Tambah Kolom",
          desc: "Tambahkan kolom baru secara dinamis ke skema tabel yang aktif.",
          columnNamePlaceholder: "misal. title",
          lengthLabel: "Panjang",
          submitBtn: "Tambah Kolom"
        },
        createIndexDialog: {
          title: "Dialog Buat Indeks",
          desc: "Tambahkan indeks optimasi kueri b-tree berkinerja tinggi pada kolom target.",
      ...
      query: {
        title: "Workspace SQL Scratchpad",
        subtitle: "Eksekusi pernyataan mentah secara langsung, dilindungi oleh batas waktu kontekstual 15 detik",
        queryPlaceholder: "SELECT * FROM table LIMIT 10;",
        outputHeader: "Output Eksekusi Kueri",
        errorLabel: "Error",
        noRecords: "Tidak ada baris yang cocok dengan kueri.",
        emptyHistory: "Belum ada kueri yang dijalankan pada sesi ini.",
        successToast: "Kueri berhasil dieksekusi.",
        failedToast: "Eksekusi kueri gagal",
        runQuery: "Jalankan Kueri",
        outputLog: "Output Log",
        awaiting: "Menunggu Instruksi",
        successMsg: "Sukses. Baris terpengaruh: {{count}}",
        failedMsg: "[EKSEKUSI KUERI GAGAL]",
        ...
        history: {
          ...
          statusFailed: "Gagal",
          btnRestore: "Kembalikan",
          btnRun: "Jalankan",
          btnCopy: "Salin",
          clearConfirmTitle: "Hapus Riwayat Kueri",
          clearConfirmDesc: "Apakah Anda yakin ingin menghapus riwayat kueri Anda? Tindakan ini permanen.",
          clearConfirmAction: "Hapus Riwayat"
        }
      },
      backups: {
        title: "Katalog Snapshot",
        desc: "Katalog snapshot cadangan database point-in-time",
        captureBtn: "Ambil Snapshot",
        empty: "Belum ada snapshot cadangan yang diambil.",
        emptyDesc: "Katalogisasi kronologis otomatis belum berjalan. Ambil snapshot cadangan manual untuk memverifikasi akses katalog.",
        capturedAt: "Diambil {{time}}",
        catalogCapacity: "Kapasitas Katalog:",
        snapshotsLabel: "snapshot",
        sreRetentionNote: "Membuat snapshot ke-6 secara otomatis menghapus arsip cadangan tertua yang selesai.",
        sreRetentionTitle: "Retensi Pruning SRE",
        sreRetentionDesc: "Katalog menjalankan antrean auto-pruning FIFO 5-backup yang ketat. Membuat snapshot ke-6 akan secara otomatis menghapus file cadangan tertua di disk.",
        actions: {
          download: "Unduh",
          restore: "Restore",
          prune: "Hapus"
        },
        confirmRestoreTitle: "Restore Snapshot Cadangan",
        confirmRestoreDesc: "PERINGATAN: Memulihkan cadangan ini akan menghapus semua tabel yang ada dan menimpa status database sepenuhnya. Lanjutkan?",
        confirmRestoreAction: "Restore Cadangan",
        confirmDeleteTitle: "Hapus Snapshot Cadangan",
        confirmDeleteDesc: "Hapus snapshot cadangan ini? Tindakan ini bersifat permanen.",
        confirmDeleteAction: "Hapus Snapshot"
      },
      upgradeModal: {
        title: "Upgrade ke Pro",
        subtitle: "Buka Fitur Auto Backup Harian & Penambahan Batas Snapshot",
        featureSnapshots: "Kelola snapshot hingga 50 file aktif (Bawaan: batas 5 file)",
        featureDaily: "Aktifkan backup harian otomatis terjadwal cron setiap tengah malam",
        featureWorker: "Sumber daya worker backup berkinerja tinggi khusus",
