export const translations = {
  en: {
    ...
    billing: {
      ...
      resource: "Resource",
      plan: "Plan",
      resourceActions: "Renewal & actions",
      ...
      unpaidPeriod: "Service period awaiting payment: {{start}} to {{end}}",
      resourceAutoRenewOnHint: "Uses your credit balance when payment is due.",
      resourceAutoRenewOffHint: "Pay manually to renew. Turning this off does not cancel unpaid bills.",
      payDueNow: "Pay now",
  ...
  id: {
    ...
    billing: {
      ...
      resource: "Resource",
      plan: "Paket",
      resourceActions: "Perpanjangan & aksi",
      ...
      unpaidPeriod: "Periode layanan yang belum dibayar: {{start}} sampai {{end}}",
      resourceAutoRenewOnHint: "Menggunakan saldo kredit saat jatuh tempo.",
      resourceAutoRenewOffHint: "Bayar manual untuk memperpanjang. Mematikan opsi ini tidak membatalkan tagihan yang belum dibayar.",
