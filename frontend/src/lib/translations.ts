export const translations = {
  ...
  id: {
    ...
    databaseStudio: {
      ...
      backups: {
        title: "Snapshot Catalog",
        desc: "Katalog penyimpanan snapshot database point-in-time",
        captureBtn: "Capture Snapshot",
        ...
        sreRetentionNote: "Membuat snapshot baru ketika kuota penuh akan otomatis menghapus snapshot tertua.",
        sreRetentionTitle: "SRE Pruning Retention",
        sreRetentionDesc: "Katalog menerapkan sistem antrean FIFO dengan batas maksimal 5 snapshot. Membuat snapshot ke-6 akan otomatis menghapus file snapshot tertua pada penyimpanan.",
        actions: {
          download: "Unduh",
          restore: "Restore",
          prune: "Prune"
