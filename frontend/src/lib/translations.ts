    ...
    billing: {
     ...
     currentPeriod: "Current period: {{start}} to {{end}}",
      ...
      profile: {
        ...
        optional: "(Optional)",
        contactTitle: "Contact & Receipt Delivery",
        email: "Billing Email",
        emailPlaceholder: "billing@company.com",
        emailHint: "Receives billing documents and payment notifications.",
        phone: "Phone Number",
    ...
    billing: {
     ...
     currentPeriod: "Periode berjalan: {{start}} sampai {{end}}",
      ...
      profile: {
        ...
        optional: "(Opsional)",
        contactTitle: "Kontak & Pengiriman Bukti Bayar",
        email: "Email Billing",
        emailPlaceholder: "billing@perusahaan.com",
        emailHint: "Menerima dokumen tagihan dan notifikasi pembayaran.",
        phone: "Nomor Telepon",
        phonePlaceholder: "+62 812 3456 7890",
