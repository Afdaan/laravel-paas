export const translations = {
  en: {
    ...
    billing: {
      ...
      autoCheckingStatus: "Status updates automatically after payment",
      payNow: "Pay",
     ...
     currentPeriod: "Current period: {{start}} to {{end}}",
      ...
      profile: {
        ...
        description: "Official invoicing and tax details for payment receipts, tax compliance (Faktur Pajak), and transaction tracking.",
        ...
        companyNameHint: "Appears on official invoices & receipts",
        taxId: "Tax ID / NPWP / NIK",
        taxIdPlaceholder: "00.000.000.0-000.000",
        taxIdHint: "Required for tax compliance (Faktur Pajak)",
        optional: "(Optional)",
        contactTitle: "Contact & Receipt Delivery",
        email: "Billing Email",
        emailPlaceholder: "billing@company.com",
        emailHint: "Invoice receipts and payment notifications",
        phone: "Phone Number",
        phonePlaceholder: "+62 812 3456 7890",
        phoneHint: "Accepts 0812..., +62812..., or international formats",
  ...
  id: {
    ...
    billing: {
      ...
      autoCheckingStatus: "Status akan diperbarui otomatis setelah pembayaran",
      payNow: "Bayar",
     ...
     currentPeriod: "Periode berjalan: {{start}} sampai {{end}}",
      ...
      profile: {
        ...
        description: "Data tagihan resmi untuk bukti pembayaran, kepatuhan pajak (Faktur Pajak), dan pelacakan transaksi.",
        ...
        companyNameHint: "Tercantum pada invoice & bukti pembayaran",
        taxId: "NPWP / NIK / NPWP Badan",
        taxIdPlaceholder: "00.000.000.0-000.000",
        taxIdHint: "Diperlukan untuk penerbitan Faktur Pajak",
        optional: "(Opsional)",
        contactTitle: "Kontak & Pengiriman Bukti Bayar",
        email: "Email Billing",
        emailPlaceholder: "billing@perusahaan.com",
        emailHint: "Bukti pembayaran & notifikasi tagihan dikirim ke sini",
        phone: "Nomor Telepon",
        phonePlaceholder: "+62 812 3456 7890",
        phoneHint: "Bisa 0812..., +62812..., atau 62812...",
