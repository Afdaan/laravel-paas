    ...
    databaseStudio: {
      ...
      dashboard: {
        ...
        activity: {
          ...
          sqlEditor: "SQL Scratchpad Editor",
          tableExplorer: "Visual Table Explorer",
          schemaArchitect: "DDL Schema Architect",
    ...
    databaseStudio: {
      ...
      dashboard: {
        ...
        activity: {
          ...
          btnTransfer: "Alihkan Database",
          toolsTitle: "Alat Workspace Cepat",
          sqlEditor: "SQL Scratchpad Editor",
          tableExplorer: "Visual Table Explorer",
          schemaArchitect: "Arsitek Skema DDL",
          totalRecords: "Total Rekaman",
          backupSnapshots: "Snapshot Cadangan",
          snapshotOne: "Snapshot",
          snapshotMany: "Snapshot"
        },
        transferModal: {
          title: "Alihkan Database",
          desc: "Alihkan database ini ke proyek lain secara aman. Proyek tujuan harus belum memiliki database.",
          labelProject: "Pilih Proyek Tujuan",
          placeholderSelect: "Pilih Proyek...",
          noProjects: "Tidak ada proyek lain yang tersedia",
          btnSubmit: "Transfer Sekarang",
          success: "Kepemilikan database berhasil dialihkan!",
          failed: "Gagal mengalihkan database"
        },
        autoBackup: {
          title: "Auto Backup (Pro)",
        ...
        sre: {
          ...
          dosCapDesc: "Membatasi koneksi maksimal hingga 15 koneksi simultan per tenant.",
          queryTimeouts: "Query Timeouts:",
          queryTimeoutsDesc: "Semua query SQL dibatasi dengan execution timeout maksimal 15 detik.",
          auditLogs: "Audit Logs:",
          auditLogsDesc: "Setiap pembaruan skema/DDL dicatat ke dalam audit log beserta alamat IP."
        }
      },
      tables: {
        title: "Tabel",
