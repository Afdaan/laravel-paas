    ...
    billing: {
     ...
     currentPeriod: "Current period: {{start}} to {{end}}",
      ...
      profile: {
        ...
        phoneHint: "Required for payment verification",
        ...
        phoneError: "Enter a valid phone number (at least 8 digits).",
    ...
    billing: {
     ...
     currentPeriod: "Periode berjalan: {{start}} sampai {{end}}",
      ...
      profile: {
        ...
        phone: "Nomor Telepon",
        phonePlaceholder: "+62 812 3456 7890",
        phoneHint: "Diperlukan untuk verifikasi pembayaran",
        ...
        phoneError: "Masukkan nomor telepon yang valid (minimal 8 digit).",
