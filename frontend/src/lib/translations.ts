export const translations = {
  en: {
    ...
    billing: {
      ...
      resourceBillingDescription: "Current billing period and next automatic renewal for each active resource.",
      noBillableResources: "No active billable resources.",
      renewsOn: "Renews on {{date}}",
      renewalPaymentDue: "Renewal payment due since {{date}}",
      periodEndsOn: "Billing period ends on {{date}}",
      unpaidPeriod: "Unpaid period: {{start}} to {{end}}",
      payDueNow: "Pay now",
  ...
  id: {
    ...
    billing: {
      ...
      resourceBillingDescription: "Ringkasan periode tagihan dan perpanjangan setiap resource aktif.",
      noBillableResources: "Belum ada resource berbayar yang aktif.",
      renewsOn: "Perpanjangan pada {{date}}",
      renewalPaymentDue: "Pembayaran perpanjangan tertunggak sejak {{date}}",
      periodEndsOn: "Periode tagihan berakhir pada {{date}}",
      unpaidPeriod: "Periode tertunggak: {{start}} sampai {{end}}",
