  ...
  en: {
    ...
    projectDetail: {
      ...
      settings: {
        ...
        internalPortDesc: "The port your application listens on (e.g. 5005). Leave empty for auto-detection.",
      ...
      console: {
        ...
        artisanPrefix: "Commands run in the project root. Use 'php artisan' for Artisan commands.",
  ...
  id: {
    ...
    projectDetail: {
      ...
      settings: {
        ...
        internalPort: "Internal Port",
        internalPortDesc: "Port yang digunakan oleh aplikasi (contoh 5005). Kosongkan untuk deteksi otomatis.",
        customDomain: "Custom Domain",
      ...
      console: {
        ...
        artisanPrefix: "Perintah berjalan dari root project. Gunakan 'php artisan' untuk perintah Artisan.",
