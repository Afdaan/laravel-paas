export const translations = {
  en: {
    ...
    login: {
      ...
      rateLimited: "Too many login attempts. Try again in {{seconds}} seconds.",
    ...
    landing: {
      ...
      hero: {
        ...
        secondaryCta: "See how deployment works"
      },
      stack: {
        eyebrow: "Supported runtimes",
        title: "Deploy applications Railpack can build.",
        description: "Runtime detection depends on repository contents and Railpack configuration."
      },
      features: {
        title: "Manage deployments and infrastructure in one place.",
        description: "Runara brings release controls, runtime operations, databases, domains, and configuration into one self-hosted dashboard.",
        groups: {
          releaseControl: {
            label: "Deployments", title: "Control each release.", description: "Connect source code, queue deployments, run configured checks, promote releases, and roll back when needed.",
            items: {
              source: { term: "Git source", description: "Connect an account, repository, and branch; push webhooks can start deployments." },
              queue: { term: "Ordered queue", description: "Deployments wait for a worker and execute in order." },
              gate: { term: "Configured checks", description: "Evaluate the runtime checks configured for the candidate." },
              rollback: { term: "Recorded rollback", description: "Use a cached image when available; otherwise rebuild the selected revision." },
              runtime: { term: "Railpack detection", description: "Detect runtime and framework signals from repository contents and Railpack output." }
            }
          },
          operate: {
            label: "Runtime", title: "Operate your applications.", description: "View logs, run guarded commands, supervise workers, and set resource limits.",
            items: {
              logs: { term: "Build and runtime logs", description: "Stream output to the dashboard while work runs." },
              console: { term: "Application commands", description: "Run application commands with checks and explicit confirmation for risky operations." },
              workers: { term: "Background workers", description: "Supervise background processes in separate containers." },
              limits: { term: "CPU and memory", description: "Set limits for project and worker containers." }
            }
          },
          dataEdge: {
            label: "Data and domains", title: "Manage application dependencies.", description: "Provision databases, manage configuration, connect domains, and handle TLS from the same dashboard.",
            items: {
              databases: { term: "MySQL or PostgreSQL", description: "Provision, attach, detach, back up, restore, import, or export project data." },
              studio: { term: "Database Studio", description: "Browse schemas, edit rows, and run SQL from the dashboard." },
              domains: { term: "Domains, DNS, TLS", description: "Connect custom domains, diagnose DNS, and handle certificates through the proxy." },
              configuration: { term: "Environment and SecretStore", description: "Manage project values and reusable encrypted secret bindings." }
            }
          }
        }
      },
      workflow: {
        title: "Ship a new version without taking the current one offline.",
        description: "Runara builds and checks the replacement while the current release keeps serving traffic. Only a healthy replacement takes over.",
        checks: {
          build: { title: "Build", description: "Railpack packages the selected revision into a new container next to the one already running." },
      ...
      final: {
        title: "Deploy your next project with Runara.",
        description: "Connect a repository, let Railpack detect the build, and manage the deployment from your own infrastructure.",
        cta: "Deploy a project",
    ...
    projectDetail: {
      metrics: {
        ...
        detectedSource: "Latest source detection",
      ...
      messages: {
        ...
        creationProjectFallback: "your project",
        creationCreated: "Project created",
        creationPreparingTitle: "Preparing {{name}}",
        creationPreparingDesc: "Your project is saved. Runara is loading its workspace and starting the first deployment.",
        creationInProgress: "Deployment in progress",
        creationDeployment: "Initial deployment",
        creationReady: "Application ready",
        creationSuccessTitle: "Project created successfully",
        creationSuccessDesc: "The first deployment is still running. Follow its live progress below.",
        creationReadyTitle: "Project is ready",
        creationReadyDesc: "The first deployment completed and your application is online.",
        creationFailedTitle: "Project created, deployment needs attention",
        creationFailedDesc: "The project is saved, but the first deployment failed. Open Build Logs to inspect the error.",
      ...
      provisioning: {
        ...
        statusDeploying: "In progress",
        statusReady: "Ready",
        statusFailed: "Needs attention",
        deployingTitle: "Preparing {{name}}",
        deployingDesc: "Your project is saved. Runara is building the application and preparing its runtime.",
        readyTitle: "{{name}} is ready",
        readyDesc: "The first deployment completed successfully. Review the project or open it when you are ready.",
        failedTitle: "{{name}} could not be deployed",
        failedDesc: "The project remains saved. Review Build Logs, fix the cause, then retry the deployment.",
        progress: "Deployment progress",
        currentActivity: "Current activity",
        waitingMessage: "Waiting for the next deployment update...",
        openProject: "Open project",
        viewBuildLogs: "View Build Logs",
        retryDeployment: "Retry deployment",
        retryStarted: "Deployment retry queued",
        retryFailed: "Failed to queue deployment retry",
        refresh: "Refresh status",
        stepCreated: "Project created",
        stepDeployment: "Initial deployment",
        stepReady: "Application ready",
        deploymentId: "Deployment ID",
        pendingId: "Pending assignment",
        startedAt: "Started",
      },
      tabs: {
        overview: "Overview",
      ...
      settings: {
        ...
        internalPortDesc: "The port your application listens on (e.g. 5005). Unknown frameworks require this unless the Docker image exposes a port. Use 0 only for private worker-only services.",
    ...
    databaseManager: {
      ...
      attachConfirm: "Attach Database?",
      attachConfirmDesc: "This will bind the database to the selected project and inject its credentials. You will need to redeploy the project for changes to take effect.",
      detachConfirm: "Detach Database?",
      detachConfirmDesc: "This will remove the database credentials from the project's environment. The project will need to be redeployed for changes to take effect. The database itself will not be deleted.",
      engine: "Engine",
      storage: "Storage",
    ...
    billing: {
      nav: "Billing",
      title: "Credits and invoices",
      description: "Manage credits, payment history, and billing status.",
      refresh: "Refresh",
      paymentRequired: "Payment required.",
      paymentRequiredDescription: "Add credits to settle overdue billing and restore access.",
      paymentDueCount: "{{count}} overdue",
      reviewOverdueBilling: "Review overdue billing",
      lowBalance: "Low credit balance.",
      lowBalanceDescription: "Add credits before your next resource charge.",
      balance: "Available balance",
      unavailable: "Unavailable",
      balanceDescription: "Credits are used for initial provisioning and monthly resource invoices.",
      addCredits: "Add credits",
      addCreditsDescription: "Select a fixed credit package. Payment is completed securely through the provider. Purchased credits are non-refundable, and deleting a project or database does not refund its remaining period.",
      choosePackage: "Choose package",
      openingCheckout: "Opening checkout…",
      bestValue: "Best value",
      noPackages: "No top-up packages are available.",
      customTopup: "Custom amount",
      customTopupLabel: "Enter amount (IDR)",
      customTopupHint: "Min Rp 10,000, max Rp 10,000,000, multiples of Rp 1,000",
      customTopupButton: "Top up",
      customTopupYouGet: "You get",
      orCustomAmount: "Or enter your own amount",
      invoices: "Invoices",
      ...
      printReceipt: "Print",
      printInvoice: "Print",
      copiedInvoice: "Invoice number copied",
      copyInvoiceNumber: "Copy invoice number",
      billedTo: "Billed to",
      profileUnavailableAtIssuance: "Profile not recorded at issuance",
      profileUnavailableHint: "This invoice was generated without a recorded profile snapshot.",
      issuerInfo: "Issued by",
      officialInvoiceTitle: "Credit Usage Statement",
      invoiceStatementTitle: "Credit Usage Statement",
      electronicDocDisclaimer: "Internal credit statement. Not a tax invoice or official fiscal receipt.",
      statementDisclaimer: "Internal credit statement. Not a tax invoice or official fiscal receipt.",
      paymentFailed: "Payment failed or expired. Please try again with a new top-up.",
      paymentEnded: "Payment session ended.",
      equivalentIdr: "IDR equivalent",
      itemDescription: "Item & Specification",
      servicePeriod: "Service period",
      paymentMethod: "Payment method",
      paymentMethodWallet: "Wallet Balance (Auto-debit)",
      invoiceStatus: "Invoice status",
      totalInvoiced: "Total invoiced",
      activeSubscriptions: "Active subscriptions",
      activeServicesCount: "{{count}} active services",
      searchInvoices: "Search invoices...",
      allStatuses: "All statuses",
      taxRate: "Tax (0% prepaid)",
      subtotal: "Subtotal",
      ...
      walletActivityDescription: "Immutable credit movements.",
      noWalletActivity: "No wallet activity yet.",
      checkStatus: "Check status",
      statusRefreshed: "Payment status refreshed.",
      statusRefreshFailed: "Unable to refresh payment status.",
      topupStartFailed: "Unable to start top-up. Please try again.",
      paymentSessionUnavailable: "Payment session unavailable",
      confirmTopupTitle: "Confirm Credit Purchase",
      confirmTopupDescription: "Please review your top-up details before proceeding to the payment provider.",
      fixedPackage: "Fixed Package",
      customPackage: "Custom Amount",
      creditsToAdd: "Credits to Add",
      packagePrice: "Credit Price",
      balanceProgression: "Wallet Balance",
      conversionRate: "Conversion rate",
      conversionRateValue: "1 Credit = {{rate}}",
      checkoutNotice: "Payment method and any provider processing fees are determined at checkout.",
      proceedToPayment: "Proceed to Payment",
      cancelTopup: "Cancel",
      paymentSecurityNote: "You will be redirected to the secure payment provider. Final payable amount including any provider fees will be shown at checkout.",
      paidOn: "Paid {{date}}",
      dueOn: "Due {{date}}",
      balanceAfter: "Balance {{balance}}",
      staleData: "Showing previously loaded data. Refresh to update.",
      loadPartial: "Some billing information is unavailable: {{sections}}. Retry to refresh it.",
      plans: "Resource plans",
      plansDescription: "Credits are charged only once the resource is created.",
      projectPlan: "Project plan",
      databasePlan: "Database plan",
      selectPlan: "Select plan",
      noPlans: "No active plans available.",
      catalogLoadFailed: "Unable to load billing plans.",
      catalogRetry: "Retry plans",
      loadError: "Unable to load {{section}}.",
      retry: "Retry",
      selectProjectPlan: "Select a project billing plan.",
      selectDatabasePlan: "Select a database billing plan.",
      creditsPerMonth: "{{credits}} credits / month",
      perMonth: "month",
      credits: "credits",
      days: "{{count}} days",
      connections: "{{count}} connections",
      nvmeStorage: "{{count}} GB NVMe SSD",
      highSpeedStorage: "{{count}} GB High-Speed Storage",
      backupRetention: "{{count}}-day automated backups",
      starterBadge: "Starter",
      popularBadge: "Popular",
      proBadge: "High Performance",
      autoSslGit: "Auto SSL & Git Deploy",
      dailyBackups: "Daily Snapshot Backups",
      creditsOverview: "Credits overview",
      upcomingCharges: "Upcoming charges",
      totalDue: "Total due",
      history: "Billing & wallet history",
      ...
      resourceBillingDescription: "Payment is due at the start of each service period. The period end date is not the payment deadline.",
      noBillableResources: "No active billable resources.",
      renewsOn: "Renews on {{date}}",
      renewalPaymentDue: "Unpaid since {{date}}",
      periodEndsOn: "Service period ends on {{date}}",
      unpaidPeriod: "For service: {{start}} – {{end}}",
      resourceAutoRenewHint: "Auto-renew uses your credit balance when payment is due. When disabled, pay manually to renew. Unpaid bills still need to be paid.",
      payDueNow: "Pay now",
      confirmDuePaymentTitle: "Confirm payment?",
      confirmDuePaymentDescription: "Your credit balance will be used to pay the overdue bill for {{name}}. This payment does not change the auto-renew setting.",
      confirmDuePaymentPeriod: "Service period: {{start}} – {{end}}",
      confirmDuePaymentAmount: "Credits to debit",
      confirmDuePaymentAmountUnavailable: "Amount unavailable. Refresh billing data.",
      confirmDuePaymentAction: "Pay bill",
      overduePaymentSuccess: "Payment complete. Billing status is updating.",
      overdueInsufficientCredits: "Insufficient credits. Add credits, then try again.",
      overduePaymentStale: "Payment details changed. Review the refreshed invoice and confirm again.",
      overduePaymentFailed: "Could not complete the overdue payment.",
      paymentSuccess: "Payment confirmed! Your wallet has been credited.",
      paymentPending: "Payment is still being processed. Status will update automatically.",
      paymentVerifyFailed: "Failed to verify payment",
      paymentDialogTitle: "Top-up Payment",
      paymentDialogDescription: "Complete the payment to credit your wallet.",
      scanQris: "Scan QRIS via Mobile Banking / E-Wallet",
      paymentCode: "Payment Code",
      totalBill: "Total Amount",
      openPaymentLink: "Open Payment Link",
      checkingStatus: "Checking...",
      checkPaymentStatus: "Check Payment Status",
      autoCheckingStatus: "Waiting for payment",
      payNow: "Pay",
      completePayment: "Pay Now",
      historyDescription: "Complete transaction ledger for invoices, credit top-ups, and balance adjustments.",
      transactionType: "Transaction Type",
      amount: "Amount",
      balanceAfterHeader: "Balance After",
      date: "Date",
      orderId: "Order ID",
      creditsPurchased: "Credits Purchased",
      amountPaid: "Amount Paid",
      status: "Status",
      loadingWalletHistory: "Loading wallet history...",
      loadingInvoices: "Loading invoices...",
      loadingTopups: "Loading top-ups...",
      failedToLoadInvoices: "Failed to load invoices",
      failedToLoadTopups: "Failed to load top-ups",
      failedToLoadLedger: "Failed to load wallet activity",
      month: "month",
     currentPeriod: "Current period: {{start}} to {{end}}",
      autoRenew: "Auto-renew",
      autoRenewEnabled: "Auto-renew enabled",
      autoRenewDisabled: "Auto-renew disabled",
      autoRenewFailed: "Could not update auto-renew",
      autoRenewRateLimited: "Too many auto-renew toggle requests. Please wait a moment before trying again.",
      enableAutoRenewTitle: "Enable auto-renew?",
      disableAutoRenewTitle: "Disable auto-renew?",
      enableAutoRenewDescription: "Credits will be debited automatically at the end of the billing period to keep {{name}} running smoothly.",
      disableAutoRenewDescription: "Automatic credit debits will be paused for {{name}}. Once the current billing period expires, the resource will enter payment-due status.",
      confirmChange: "Confirm",
      cancel: "Cancel",
      invoicesUnavailable: "Invoice history unavailable.",
      walletActivityUnavailable: "Wallet activity unavailable.",
      resourceId: "Resource #{{id}}",
      profile: {
        title: "Billing Profile & Tax Details",
        description: "Used to issue invoices, payment receipts, and tax documents.",
        identityTitle: "Identity & Tax Identification",
        companyName: "Full Name / Company Name",
        companyNamePlaceholder: "e.g. PT Acme Corporation / John Doe",
        companyNameHint: "Printed on invoices and payment receipts.",
        taxId: "Tax ID / NPWP / NIK",
        taxIdPlaceholder: "00.000.000.0-000.000",
        taxIdHint: "Used to issue a Faktur Pajak when applicable.",
        optional: "(Optional)",
        contactTitle: "Contact & Receipt Details",
        email: "Billing Email",
        emailPlaceholder: "billing@company.com",
        emailHint: "Contact email recorded on billing receipts and account correspondence.",
        phone: "Phone Number",
        phonePlaceholder: "+62 812 3456 7890",
        phoneHint: "Use an Indonesian or international phone number.",
        addressTitle: "Billing Address",
        streetAddress: "Street Address",
        streetAddressPlaceholder: "Jalan Utama No. 123, Lt. 4",
        city: "City",
        cityPlaceholder: "Jakarta Selatan",
        postalCode: "Postal Code",
        postalCodePlaceholder: "12340",
        country: "Country",
        countryValue: "Indonesia (IDN)",
        save: "Save Billing Profile",
        saving: "Saving...",
        saved: "Billing profile updated successfully",
        saveFailed: "Failed to update billing profile",
        profileRequired: "Please complete your billing profile (Name, Email, Phone, Address, City, Postal Code) before attempting a top-up.",
        profileRequiredTitle: "Billing Profile Required",
        profileRequiredDesc: "Before completing top-up purchases, please provide your billing details (Name, Email, Phone, Address, City, Postal Code) for payment invoices & verification.",
        completeProfileBtn: "Complete Profile",
        incompleteBanner: "Please complete your billing profile (Name, Email, Phone, Address, City, Postal Code) to enable credit top-ups.",
        companyNameError: "Full name or company name must be at least 2 characters.",
        emailError: "Enter a valid email address.",
        phoneError: "Enter a valid phone number (e.g. 08123456789 or +628123456789).",
        streetAddressError: "Street address must be at least 5 characters.",
        cityError: "City name must be at least 2 characters.",
        postalCodeError: "Postal code must be a 5-digit number.",
        taxIdError: "Tax ID (NPWP/NIK) must be 15-16 digits.",
        fillAllFieldsHint: "Complete all required fields with valid details to enable saving.",
      },
      admin: {
        ...
        invoicesDescription: "Generated monthly resource usage invoices",
        topupsDescription: "Purchased credit package payments and status",
        walletsDescription: "User credit balance activity and manual adjustment",
        resourcePlansDescription: "Active and historical compute resource pricing specs",
        topupPackagesDescription: "Purchasable credit bundle offers",
        suspensionsDescription: "The following resources are currently suspended or marked as payment due.",
        suspensionsTab: "Overdue",
        searchInvoices: "Search invoice or user…",
        searchTopups: "Search top-up or user…",
        searchWallets: "Search name, email, or user ID…",
        ...
        createPlan: "Create plan version",
        editPlan: "Edit plan",
        editingPlan: "Editing {{name}} (v{{version}}). Saving creates a new version and retires this one. Type, name, and slug are locked — create a separate plan to change those.",
        saveNewVersion: "Save as new version",
        createPackage: "Create top-up package version",
        versionedPricing: "Changes create a new active version and retire the previous matching version.",
        superadminOnly: "Only superadmins can create pricing versions. Recent authentication is required.",
        name: "Name",
        slug: "Slug",
        slugHint: "Permanent identifier. Lowercase, numbers, and dashes only.",
        ...
        searchSpecs: "Search plans...",
        searchPackages: "Search packages...",
        cpu: "CPU millicores",
        cpuHint: "1000 = 1 full core.",
        memory: "Memory MB",
        storage: "Storage GB",
        monthlyCredits: "Monthly credits",
        monthlyCreditsHint: "Costs the user {{price}} per month.",
        ...
        reason: "Audit reason",
        reasonHint: "Recorded in the audit log. Explain why this version exists.",
        reasonPlaceholder: "e.g. Raise memory to 4 GB after Q3 capacity review",
        create: "Create version",
        createFailed: "Unable to create billing version.",
        createSucceeded: "Billing version created.",
        wallets: "Wallets",
        invoices: "Invoices",
        topups: "Top-ups",
        suspensions: "Payment due and suspended resources",
        ...
        period: "Period",
        updated: "Updated",
        total: "Showing {{count}} of {{total}}",
        loadFailed: "Unable to load {{section}}.",
        active: "active",
        inactive: "inactive",
        editPackage: "Edit package",
        editPackageDescription: "Update the price or sort order. The credit amount stays the same and a new version is created.",
        addCredits: "Add credits",
        addCreditsDescription: "Manually add credits to this user's wallet.",
        addCreditsForUser: "Add credits for user",
        addCreditsForUserDescription: "Add credits to another user or admin's wallet by selecting user or entering ID.",
        selectUser: "Select User",
        chooseUser: "Choose user...",
        creditsAmount: "Credits",
        savePackage: "Save package",
        saveCredits: "Add credits",
        userId: "User ID",
        adjustmentSuccess: "Credits adjusted.",
        adjustmentFailed: "Unable to adjust credits.",
        updatePackageSuccess: "Package updated.",
        updatePackageFailed: "Unable to update package.",
      },
    }
  },
  id: {
    ...
    login: {
      ...
      rateLimited: "Terlalu banyak percobaan login. Coba lagi dalam {{seconds}} detik.",
      retryIn: "Coba lagi dalam {{seconds}} dtk",
    ...
    projectDetail: {
      metrics: {
        ...
        standardRuntime: "Managed Stack",
        managedStack: "Managed Stack",
        detectedSource: "Deteksi source terbaru",
      ...
      messages: {
        ...
        creationProjectFallback: "project Anda",
        creationCreated: "Project berhasil dibuat",
        creationPreparingTitle: "Menyiapkan {{name}}",
        creationPreparingDesc: "Project sudah tersimpan. Runara sedang memuat workspace dan memulai deployment pertama.",
        creationInProgress: "Deployment sedang berjalan",
        creationDeployment: "Deployment pertama",
        creationReady: "Aplikasi siap",
        creationSuccessTitle: "Project berhasil dibuat",
        creationSuccessDesc: "Deployment pertama masih berjalan. Pantau progres live di bawah ini.",
        creationReadyTitle: "Project sudah siap",
        creationReadyDesc: "Deployment pertama selesai dan aplikasi sudah online.",
        creationFailedTitle: "Project dibuat, deployment perlu diperiksa",
        creationFailedDesc: "Project sudah tersimpan, tetapi deployment pertama gagal. Buka Build Logs untuk melihat error.",
      ...
      provisioning: {
        ...
        statusDeploying: "Sedang berjalan",
        statusReady: "Siap",
        statusFailed: "Perlu diperiksa",
        deployingTitle: "Menyiapkan {{name}}",
        deployingDesc: "Project sudah tersimpan. Runara sedang membangun aplikasi dan menyiapkan runtime.",
        readyTitle: "{{name}} sudah siap",
        readyDesc: "Deployment pertama berhasil diselesaikan. Periksa detail project atau buka aplikasinya.",
        failedTitle: "{{name}} gagal dideploy",
        failedDesc: "Project tetap tersimpan. Periksa Build Logs, perbaiki penyebabnya, lalu ulangi deployment.",
        progress: "Progres deployment",
        currentActivity: "Aktivitas saat ini",
        waitingMessage: "Menunggu pembaruan deployment berikutnya...",
        openProject: "Buka project",
        viewBuildLogs: "Lihat Build Logs",
        retryDeployment: "Ulangi deployment",
        retryStarted: "Deployment ulang masuk antrean",
        retryFailed: "Gagal memasukkan deployment ulang ke antrean",
        refresh: "Refresh status",
        stepCreated: "Project dibuat",
        stepDeployment: "Deployment pertama",
        stepReady: "Aplikasi siap",
        deploymentId: "Deployment ID",
        pendingId: "Menunggu penetapan",
        startedAt: "Dimulai",
      },
      tabs: {
        overview: "Overview",
      ...
      settings: {
        ...
        internalPort: "Internal Port",
        internalPortDesc: "Port yang digunakan oleh aplikasi (contoh 5005). Framework tidak dikenal wajib mengisi ini kecuali image Docker expose port. Pakai 0 hanya untuk private worker-only service.",
        customDomain: "Custom Domain",
    ...
    databaseManager: {
      ...
      attachConfirm: "Hubungkan Database?",
      attachConfirmDesc: "Ini akan menghubungkan database ke project yang dipilih dan menyuntikkan kredensialnya. Anda harus men-deploy ulang project agar perubahan diterapkan.",
      detachConfirm: "Lepaskan Database?",
      detachConfirmDesc: "Ini akan menghapus kredensial database dari lingkungan project. Project harus di-deploy ulang agar perubahan diterapkan. Database itu sendiri tidak akan dihapus.",
      engine: "Mesin",
      storage: "Penyimpanan",
    ...
    billing: {
      nav: "Penagihan",
      title: "Kredit dan invoice",
      description: "Kelola kredit, riwayat pembayaran, dan status penagihan.",
      refresh: "Muat ulang",
      paymentRequired: "Pembayaran diperlukan.",
      paymentRequiredDescription: "Tambah kredit untuk melunasi tagihan tertunggak dan memulihkan akses.",
      paymentDueCount: "{{count}} tertunggak",
      reviewOverdueBilling: "Tinjau tagihan tertunggak",
      lowBalance: "Saldo kredit rendah.",
      lowBalanceDescription: "Tambah kredit sebelum tagihan resource berikutnya.",
      balance: "Saldo tersedia",
      unavailable: "Tidak tersedia",
      balanceDescription: "Kredit digunakan untuk provisioning awal dan invoice resource bulanan.",
      addCredits: "Tambah kredit",
      addCreditsDescription: "Pilih paket kredit tetap. Pembayaran diselesaikan aman melalui provider. Kredit yang sudah dibeli tidak dapat di-refund, dan menghapus project atau database tidak mengembalikan sisa periode billing.",
      choosePackage: "Pilih paket",
      openingCheckout: "Membuka checkout…",
      bestValue: "Paling hemat",
      noPackages: "Tidak ada paket top-up tersedia.",
      customTopup: "Nominal kustom",
      customTopupLabel: "Masukkan nominal (IDR)",
      customTopupHint: "Min Rp 10.000, maks Rp 10.000.000, kelipatan Rp 1.000",
      customTopupButton: "Top up",
      customTopupYouGet: "Kamu dapat",
      orCustomAmount: "Atau masukkan nominal sendiri",
      noInvoices: "Belum ada invoice.",
      topups: "Top-up",
      noTopups: "Belum ada top-up.",
      topupsUnavailable: "Riwayat top-up tidak tersedia.",
      walletActivity: "Aktivitas wallet",
      walletActivityDescription: "Pergerakan kredit yang immutable.",
      noWalletActivity: "Belum ada aktivitas wallet.",
      checkStatus: "Cek status",
      statusRefreshed: "Status pembayaran diperbarui.",
      statusRefreshFailed: "Tidak dapat memperbarui status pembayaran.",
      topupStartFailed: "Tidak dapat memulai top-up. Coba lagi.",
      paymentSessionUnavailable: "Sesi pembayaran tidak tersedia",
      confirmTopupTitle: "Konfirmasi Pembelian Kredit",
      confirmTopupDescription: "Pastikan rincian nominal dan paket sudah sesuai sebelum melanjutkan ke halaman pembayaran.",
      fixedPackage: "Paket Tetap",
      customPackage: "Nominal Kustom",
      creditsToAdd: "Kredit yang Didapat",
      packagePrice: "Harga Kredit",
      balanceProgression: "Saldo Wallet",
      conversionRate: "Kurs konversi",
      conversionRateValue: "1 Kredit = {{rate}}",
      checkoutNotice: "Metode pembayaran & biaya transaksi provider (jika ada) ditentukan saat checkout.",
      proceedToPayment: "Lanjut ke Pembayaran",
      cancelTopup: "Batal",
      paymentSecurityNote: "Anda akan dialihkan ke sistem pembayaran provider resmi. Total akhir tagihan beserta biaya transaksi provider akan ditampilkan pada saat checkout.",
      paidOn: "Dibayar {{date}}",
      dueOn: "Jatuh tempo {{date}}",
      balanceAfter: "Saldo {{balance}}",
      staleData: "Menampilkan data sebelumnya. Muat ulang untuk memperbarui.",
      loadPartial: "Sebagian informasi billing tidak tersedia: {{sections}}. Coba muat ulang.",
      plans: "Paket Resource",
      plansDescription: "Kredit ditagih hanya setelah resource berhasil dibuat.",
      projectPlan: "Paket project",
      databasePlan: "Paket database",
      selectPlan: "Pilih paket",
      noPlans: "Tidak ada paket aktif tersedia.",
      catalogLoadFailed: "Tidak dapat memuat paket billing.",
      catalogRetry: "Coba lagi",
      loadError: "Gagal memuat {{section}}.",
      retry: "Coba lagi",
      selectProjectPlan: "Pilih paket billing project.",
      selectDatabasePlan: "Pilih paket billing database.",
      creditsPerMonth: "{{credits}} kredit / bulan",
      perMonth: "bulan",
      credits: "kredit",
      days: "{{count}} hari",
      connections: "{{count}} koneksi",
      nvmeStorage: "{{count}} GB NVMe SSD",
      highSpeedStorage: "{{count}} GB Penyimpanan Cepat",
      backupRetention: "Backup otomatis {{count}} hari",
      starterBadge: "Starter",
      popularBadge: "Populer",
      proBadge: "Performa Tinggi",
      autoSslGit: "Auto SSL & Git Deploy",
      dailyBackups: "Backup Snapshot Harian",
      creditsOverview: "Ringkasan kredit",
      upcomingCharges: "Tagihan mendatang",
      ...
      statuses: {
        ...
        paid: "dibayar",
        pending: "menunggu",
        payment_due: "perlu pembayaran",
        suspended: "tersuspensi",
        void: "dibatalkan",
      },
      topupStatuses: {
        pending: "menunggu",
      ...
      resource: "Resource",
      plan: "Paket",
      resourceActions: "Aksi",
      resourceBilling: "Tagihan resource",
      resourceBillingDescription: "Pembayaran dilakukan di awal setiap periode layanan. Tanggal akhir periode bukan batas pembayaran.",
      noBillableResources: "Belum ada resource berbayar yang aktif.",
      renewsOn: "Perpanjangan pada {{date}}",
      renewalPaymentDue: "Belum dibayar sejak {{date}}",
      periodEndsOn: "Periode layanan berakhir pada {{date}}",
      unpaidPeriod: "Untuk layanan: {{start}} – {{end}}",
      resourceAutoRenewHint: "Perpanjangan otomatis menggunakan saldo kredit saat jatuh tempo. Jika nonaktif, bayar manual untuk memperpanjang. Tagihan yang belum dibayar tetap berlaku.",
      payDueNow: "Bayar sekarang",
      confirmDuePaymentTitle: "Konfirmasi pembayaran?",
      confirmDuePaymentDescription: "Saldo kredit Anda akan digunakan untuk membayar tagihan tertunggak {{name}}. Pembayaran ini tidak mengubah pengaturan perpanjangan otomatis.",
      confirmDuePaymentPeriod: "Periode layanan: {{start}} – {{end}}",
      confirmDuePaymentAmount: "Kredit yang dipotong",
      confirmDuePaymentAmountUnavailable: "Nominal tidak tersedia. Muat ulang data tagihan.",
      confirmDuePaymentAction: "Bayar tagihan",
      overduePaymentSuccess: "Pembayaran selesai. Status billing sedang diperbarui.",
      overdueInsufficientCredits: "Kredit tidak cukup. Tambahkan kredit, lalu coba lagi.",
      overduePaymentStale: "Detail pembayaran berubah. Periksa tagihan terbaru lalu konfirmasi kembali.",
      overduePaymentFailed: "Pembayaran tagihan tertunggak gagal diproses.",
      paymentSuccess: "Pembayaran berhasil! Kredit telah masuk ke wallet Anda.",
      paymentPending: "Pembayaran masih diproses. Status akan diperbarui otomatis.",
      paymentVerifyFailed: "Gagal memverifikasi pembayaran",
      paymentDialogTitle: "Pembayaran Top-up",
      paymentDialogDescription: "Silakan selesaikan pembayaran untuk mengisi kredit wallet.",
      scanQris: "Scan QRIS via Mobile Banking / E-Wallet",
      paymentCode: "Kode / Nomor Pembayaran",
      totalBill: "Total Tagihan",
      openPaymentLink: "Buka Link Pembayaran",
      checkingStatus: "Mengecek...",
      checkPaymentStatus: "Cek Status Pembayaran",
      autoCheckingStatus: "Menunggu pembayaran",
      payNow: "Bayar",
      completePayment: "Bayar Sekarang",
      historyDescription: "Riwayat transaksi lengkap untuk invoice, top-up kredit, dan penyesuaian saldo.",
      transactionType: "Jenis Transaksi",
      amount: "Nominal",
      balanceAfterHeader: "Saldo Setelahnya",
      date: "Tanggal",
      orderId: "ID Order",
      creditsPurchased: "Kredit Dibeli",
      amountPaid: "Nominal Dibayar",
      status: "Status",
      loadingWalletHistory: "Memuat riwayat wallet...",
      loadingInvoices: "Memuat invoice...",
      loadingTopups: "Memuat top-up...",
      failedToLoadInvoices: "Gagal memuat invoice",
      failedToLoadTopups: "Gagal memuat top-up",
      failedToLoadLedger: "Gagal memuat riwayat wallet",
      month: "bulan",
     currentPeriod: "Periode berjalan: {{start}} sampai {{end}}",
      autoRenew: "Perpanjang otomatis",
      autoRenewEnabled: "Perpanjangan otomatis aktif",
      autoRenewDisabled: "Perpanjangan otomatis dimatikan",
      autoRenewFailed: "Gagal mengubah perpanjangan otomatis",
      autoRenewRateLimited: "Batas ubah perpanjangan otomatis tercapai. Harap tunggu sebentar sebelum mencoba lagi.",
      enableAutoRenewTitle: "Aktifkan perpanjangan otomatis?",
      disableAutoRenewTitle: "Matikan perpanjangan otomatis?",
      enableAutoRenewDescription: "Kredit akan dipotong otomatis pada akhir periode tagihan agar {{name}} tetap berjalan tanpa hambatan.",
      disableAutoRenewDescription: "Pemotongan kredit otomatis untuk {{name}} akan dihentikan. Setelah periode tagihan berakhir, resource akan masuk status perlu pembayaran.",
      confirmChange: "Ya, Ubah",
      cancel: "Batal",
      invoicesUnavailable: "Riwayat invoice tidak tersedia.",
      invoiceNumber: "No. Invoice",
      viewReceipt: "Lihat Tagihan",
      viewInvoice: "Lihat Tagihan",
      printReceipt: "Cetak",
      printInvoice: "Cetak",
      copiedInvoice: "Nomor invoice disalin",
      copyInvoiceNumber: "Salin nomor invoice",
      billedTo: "Ditagihkan kepada",
      profileUnavailableAtIssuance: "Profil tidak tercatat saat penerbitan",
      profileUnavailableHint: "Invoice ini diterbitkan tanpa snapshot profil billing yang tersimpan.",
      issuerInfo: "Penerbit",
      officialInvoiceTitle: "Rincian Penggunaan Kredit",
      invoiceStatementTitle: "Rincian Penggunaan Kredit",
      electronicDocDisclaimer: "Rincian penggunaan kredit internal. Bukan faktur pajak atau bukti bayar resmi.",
      statementDisclaimer: "Rincian penggunaan kredit internal. Bukan faktur pajak atau bukti bayar resmi.",
      paymentFailed: "Pembayaran gagal atau kedaluwarsa. Silakan coba kembali dengan top-up baru.",
      paymentEnded: "Sesi pembayaran telah berakhir.",
      equivalentIdr: "Estimasi IDR",
      itemDescription: "Item & Spesifikasi",
      servicePeriod: "Periode layanan",
      paymentMethod: "Metode pembayaran",
      paymentMethodWallet: "Saldo Wallet (Auto-debit)",
      invoiceStatus: "Status tagihan",
      totalInvoiced: "Total tagihan",
      activeSubscriptions: "Layanan aktif",
      activeServicesCount: "{{count}} layanan aktif",
      searchInvoices: "Cari invoice...",
      allStatuses: "Semua status",
      taxRate: "Pajak (0% prepaid)",
      subtotal: "Subtotal",
      totalCharged: "Total tagihan",
      periodLabel: "Periode",
      ...
      resourceId: "Resource #{{id}}",
      profile: {
        title: "Profil Billing & Data Pajak",
        description: "Digunakan untuk menerbitkan invoice, bukti pembayaran, dan dokumen pajak.",
        identityTitle: "Identitas & Identifikasi Pajak",
        companyName: "Nama Lengkap / Nama Perusahaan",
        companyNamePlaceholder: "contoh: PT Acme Corporation / John Doe",
        companyNameHint: "Dicantumkan pada invoice dan bukti pembayaran.",
        taxId: "NPWP / NIK / NPWP Badan",
        taxIdPlaceholder: "00.000.000.0-000.000",
        taxIdHint: "Digunakan untuk menerbitkan Faktur Pajak jika diperlukan.",
        optional: "(Opsional)",
        contactTitle: "Kontak & Informasi Bukti Tagihan",
        email: "Email Billing",
        emailPlaceholder: "billing@perusahaan.com",
        emailHint: "Email kontak yang tercatat pada bukti tagihan dan korespondensi akun.",
        phone: "Nomor Telepon",
        phonePlaceholder: "+62 812 3456 7890",
        phoneHint: "Gunakan nomor Indonesia atau nomor internasional.",
        addressTitle: "Alamat Tagihan",
        ...
        country: "Negara",
        countryValue: "Indonesia (IDN)",
        save: "Simpan Profil Billing",
        saving: "Menyimpan...",
        saved: "Profil billing berhasil diperbarui",
        saveFailed: "Gagal memperbarui profil billing",
        profileRequired: "Harap lengkapi profil billing (Nama, Email, No. Telp, Alamat, Kota, Kode Pos) sebelum melakukan top-up.",
        profileRequiredTitle: "Profil Billing Diperlukan",
        profileRequiredDesc: "Sebelum melakukan top-up kredit, harap lengkapi profil billing Anda (Nama, Email, No. Telp, Alamat, Kota, Kode Pos) untuk invoice dan verifikasi pembayaran.",
        completeProfileBtn: "Lengkapi Profil",
        incompleteBanner: "Harap lengkapi profil billing (Nama, Email, No. Telp, Alamat, Kota, Kode Pos) agar dapat melakukan top-up.",
        companyNameError: "Nama lengkap / nama perusahaan minimal 2 karakter.",
        emailError: "Masukkan alamat email yang valid.",
        phoneError: "Masukkan nomor telepon yang valid (misal: 08123456789 atau +628123456789).",
        streetAddressError: "Alamat lengkap minimal 5 karakter.",
        cityError: "Nama kota/kabupaten minimal 2 karakter.",
        postalCodeError: "Kode pos harus 5 digit angka.",
        taxIdError: "NPWP/NIK harus 15-16 digit angka.",
        fillAllFieldsHint: "Lengkapi semua bidang wajib dengan format valid untuk menyimpan profil.",
      },
      admin: {
        ...
        status: "Status",
        topupId: "ID Top-up",
        lineItems: "Rincian item",
        noLineItems: "Tidak ada rincian item pada invoice ini.",
        resource: "Resource",
        role: "Peran",
        ...
        paidDue: "Dibayar / jatuh tempo",
        detail: "Detail",
        amountPaid: "Nominal dibayar",
        date: "Tanggal",
        oldestDueDate: "Jatuh tempo terlama",
        overdueDays: "Hari terlambat",
        invoicesDescription: "Invoice pemakaian resource bulanan yang tergenerate",
        topupsDescription: "Pembayaran paket kredit dan statusnya",
        walletsDescription: "Aktivitas saldo kredit pengguna dan penyesuaian manual",
        resourcePlansDescription: "Spesifikasi harga resource komputasi aktif dan historis",
        topupPackagesDescription: "Penawaran paket kredit yang bisa dibeli",
        suspensionsDescription: "Resource berikut sedang tersuspensi atau berstatus perlu pembayaran.",
        suspensionsTab: "Jatuh tempo",
        searchInvoices: "Cari invoice atau pengguna…",
        searchTopups: "Cari top-up atau pengguna…",
        searchWallets: "Cari nama, email, atau ID pengguna…",
        ...
        createPlan: "Buat versi paket",
        editPlan: "Edit paket",
        editingPlan: "Mengedit {{name}} (v{{version}}). Menyimpan membuat versi baru dan menonaktifkan versi ini. Tipe, nama, dan slug terkunci — buat paket terpisah untuk mengubahnya.",
        saveNewVersion: "Simpan sebagai versi baru",
        createPackage: "Buat versi paket top-up",
        versionedPricing: "Perubahan membuat versi aktif baru dan menonaktifkan versi cocok sebelumnya.",
        superadminOnly: "Hanya superadmin dapat membuat versi harga. Autentikasi terbaru wajib.",
        name: "Nama",
        slug: "Slug",
        slugHint: "Identifier permanen. Hanya huruf kecil, angka, dan tanda hubung.",
        ...
        allStatuses: "Semua status",
        activeOnly: "Aktif",
        inactiveOnly: "Nonaktif",
        searchSpecs: "Cari paket...",
        searchPackages: "Cari paket topup...",
        cpu: "CPU millicore",
        cpuHint: "1000 = 1 core penuh.",
        memory: "Memori MB",
        storage: "Penyimpanan GB",
        monthlyCredits: "Kredit bulanan",
        monthlyCreditsHint: "Biaya user {{price}} per bulan.",
        connectionLimit: "Batas koneksi",
        backupRetentionDays: "Hari retensi backup",
        badgeText: "Badge / Label (Opsional)",
        credits: "Kredit",
        amountMinor: "Nominal minor",
        packagePrice: "Harga paket",
        currency: "Mata uang",
        sortOrder: "Urutan",
        reason: "Alasan audit",
        reasonHint: "Tercatat di audit log. Jelaskan alasan versi ini dibuat.",
        reasonPlaceholder: "mis. Naikkan memori ke 4 GB setelah review kapasitas Q3",
        create: "Buat versi",
        createFailed: "Tidak dapat membuat versi billing.",
        createSucceeded: "Versi billing dibuat.",
        wallets: "Wallet",
        invoices: "Invoice",
        topups: "Top-up",
        suspensions: "Resource jatuh tempo dan tersuspensi",
        ...
        period: "Periode",
        updated: "Diperbarui",
        total: "Menampilkan {{count}} dari {{total}}",
        loadFailed: "Tidak dapat memuat {{section}}.",
        active: "aktif",
        inactive: "nonaktif",
        editPackage: "Edit paket",
        editPackageDescription: "Perbarui harga atau urutan. Jumlah kredit tetap sama dan versi baru dibuat.",
        addCredits: "Tambah kredit",
        addCreditsDescription: "Tambahkan kredit secara manual ke wallet pengguna ini.",
        addCreditsForUser: "Tambah kredit untuk user",
        addCreditsForUserDescription: "Tambahkan kredit ke wallet user atau admin lain dengan memilih user atau memasukkan ID.",
        selectUser: "Pilih User",
        chooseUser: "Pilih user...",
        creditsAmount: "Kredit",
        savePackage: "Simpan paket",
        saveCredits: "Tambah kredit",
        userId: "ID User",
        adjustmentSuccess: "Kredit disesuaikan.",
        adjustmentFailed: "Tidak dapat menyesuaikan kredit.",
        updatePackageSuccess: "Paket diperbarui.",
        updatePackageFailed: "Tidak dapat memperbarui paket.",
      },
    }
  },
}
