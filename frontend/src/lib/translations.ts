  ...
  en: {
    ...
    admin: {
      ...
      settings: {
        ...
        scaleToZeroIdleMin: "Scale to Zero Idle Timeout",
        scaleToZeroIdleMinDesc: "Number of minutes a project can remain inactive before it is auto-stopped (scaled to zero). Set to 0 to disable.",
        images: "Images",
        mins: "Mins",
    ...
    projectDetail: {
      ...
      runtime: {
        ...
        scaleToZeroActive: "Sleeping (Scale to Zero)",
      ...
      settings: {
        ...
        disableScaleToZero: "Disable Scale to Zero (Keep Alive)",
        disableScaleToZeroDesc: "Prevent this project from going to sleep automatically when inactive (highly recommended for bots or background processes)",
        phpTitle: "PHP Stack",
  ...
  id: {
    ...
    admin: {
      ...
      settings: {
        ...
        scaleToZeroIdleMin: "Scale to Zero Idle Timeout",
        scaleToZeroIdleMinDesc: "Jumlah menit suatu project boleh tidak aktif sebelum dihentikan otomatis (scale to zero). Set ke 0 untuk menonaktifkan.",
        images: "Image",
        mins: "Menit",
        concurrentBuilds: "Worker Concurrency",
        workers: "Worker",
    ...
    projectDetail: {
      ...
      runtime: {
        ...
        scaleToZeroActive: "Tidur (Scale to Zero)",
      ...
      settings: {
        ...
        disableScaleToZero: "Nonaktifkan Scale to Zero (Selalu Aktif)",
        disableScaleToZeroDesc: "Mencegah project ini dari mati otomatis saat tidak ada aktivitas (sangat direkomendasikan untuk bot atau background process)",
        phpTitle: "PHP Stack",
