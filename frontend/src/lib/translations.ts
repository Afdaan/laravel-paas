  ...
  id: {
    ...
    user: {
      ...
      settings: {
        ...
        gitConfigDesc: "Hubungkan kembali proyek Anda ke instalasi GitHub App baru atau ubah mode koneksi.",
    ...
    databaseStudio: {
      ...
      errors: {
        connectFailed: "Gagal menghubungkan Managed Database. Pastikan proyek berjalan.",
      ...
      dashboard: {
        ...
        credentials: {
          title: "Connection Credentials",
          subtitle: "Internal credentials untuk koneksi container proyek",
          host: "Host",
          port: "Port",
          databaseName: "Database Name",
          username: "Username",
