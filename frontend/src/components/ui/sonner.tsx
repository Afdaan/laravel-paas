...
const Toaster = ({ ...props }: ToasterProps) => {
  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast: "group rounded-2xl !p-4 !pr-12 !flex !gap-3.5 border backdrop-blur-xl font-sans text-sm select-none transition-all duration-300 w-[380px] shadow-2xl !items-start",
          ...
          actionButton: "!bg-primary !text-primary-foreground !rounded-lg !font-medium !text-xs !px-3.5 !py-1.5 !transition-colors hover:!bg-primary/90 !ml-auto !self-center !shrink-0",
          cancelButton: "!bg-muted !text-muted-foreground !rounded-lg !font-medium !text-xs !px-3.5 !py-1.5 !transition-colors hover:!bg-muted/80 !ml-auto !self-center !shrink-0",
