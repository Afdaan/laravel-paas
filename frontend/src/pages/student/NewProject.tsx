        ...
        <form onSubmit={handleSubmit} noValidate className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-pop-in" style={{ animationDelay: '100ms' }}>
            ...
            <div className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm p-10 space-y-8 border-slate-300 dark:border-white/10">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <label htmlFor="name" className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-widest">
                    Project Name
                  </label>
                </div>
                <input
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <label htmlFor="branch" className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-widest">
                      Git Branch
                    </label>
                  </div>
                  <input
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <label htmlFor="database_name" className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-widest">
                    Database Name
                  </label>
                </div>
                <input
                ...
                <div className="flex items-start gap-4">
                  <div className="flex items-center h-6 mt-1">
                    <input
                      ...
                      onChange={handleChange}
                      className="w-5 h-5 rounded-lg border-slate-300 dark:border-white/20 bg-black/40 text-indigo-500 focus:ring-0 cursor-pointer"
                    />
                  </div>
                  <div>
                    <label htmlFor="queue_enabled" className="block text-sm font-black text-slate-900 dark:text-white uppercase tracking-widest cursor-pointer">Enable Queue Worker</label>
                    <p className="text-slate-600 dark:text-slate-400 text-xs mt-1 font-medium italic">Enables background processes for your application.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm p-8 border-slate-300 dark:border-white/10 space-y-8 bg-gradient-to-br from-white/[0.03] to-transparent">
              ...
              <div className="p-4 rounded-xl bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/5 flex items-start gap-3">
                <Info className="w-4 h-4 text-slate-600 dark:text-slate-400 mt-0.5" />
                <p className="text-[10px] text-slate-600 dark:text-slate-400 font-bold uppercase tracking-wider leading-relaxed">
...
function PipelineStep({ icon: Icon, title, desc }) {
  return (
    <li className="flex gap-4 group">
      <div className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/5 flex items-center justify-center text-slate-600 dark:text-slate-400 group-hover:text-indigo-400 transition-colors shrink-0">
        <Icon className="w-5 h-5" />
      </div>
      <div>
        <h4 className="text-xs font-black text-slate-900 dark:text-white uppercase tracking-widest mb-1">{title}</h4>
        <p className="text-[11px] text-slate-600 dark:text-slate-400 font-medium leading-normal">{desc}</p>
      </div>
    </li>
  )
}
