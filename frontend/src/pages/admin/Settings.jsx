    ...
    if (isLoading) {
        return (
            <div className="flex flex-col items-center justify-center h-80 gap-6">
                ...
                <p className="text-slate-600 dark:text-slate-400 text-[10px] font-black uppercase tracking-[0.3em] animate-pulse">Retrieving System Manifest</p>
            </div>
        )
    }
        ...
        <div className="space-y-12 animate-pop-in relative h-full pb-20">
            ...
            <div className="relative z-10">
                <div className="flex flex-col xl:flex-row xl:items-end justify-between mb-16 gap-8">
                    <div>
                        <h1 className="text-5xl font-black text-slate-900 dark:text-white tracking-tighter mb-4 italic">Core <span className="text-transparent bg-clip-text pr-2 pb-1 bg-gradient-to-r from-indigo-400 to-purple-400">Parameters</span></h1>
                        <p className="text-slate-600 dark:text-slate-400 text-lg font-medium">Configure global orchestration limits, resource pooling, and network topology.</p>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    ...
                    <div className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm p-10 bg-slate-50 dark:bg-slate-100 dark:bg-white/5 border-slate-300 dark:border-white/10 group overflow-hidden relative transition-all duration-500 hover:bg-slate-100 dark:bg-slate-100 dark:bg-white/5 hover:border-slate-300 dark:border-white/20">
                         ...
                         <div className="flex items-center gap-4 mb-10">
                            ...
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tight">Domain Topology</h2>
                                <p className="text-xs text-slate-600 dark:text-slate-400 font-bold tracking-widest uppercase mt-1">Network Identity Routing</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-8">
                            <div className="space-y-3">
                                ...
                                <input
                                    ...
                                    className="w-full bg-black/40 border border-slate-300 dark:border-white/10 rounded-2xl px-5 py-4 text-slate-900 dark:text-white font-medium focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500/40 transition-all outline-none"
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="p-4 rounded-xl bg-purple-500/5 border border-purple-500/10 flex items-center gap-4">
                                     ...
                                     <div className="flex-1 text-[11px] font-mono text-slate-600 dark:text-slate-400 truncate">
                    ...
                    <div className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm p-10 bg-slate-50 dark:bg-slate-100 dark:bg-white/5 border-slate-300 dark:border-white/10 group overflow-hidden relative transition-all duration-500 hover:bg-slate-100 dark:bg-slate-100 dark:bg-white/5 hover:border-slate-300 dark:border-white/20">
                         ...
                         <div className="flex items-center gap-4 mb-10">
                            ...
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tight">Security Limits</h2>
                                <p className="text-xs text-slate-600 dark:text-slate-400 font-bold tracking-widest uppercase mt-1">Resource Quota Enforcement</p>
                            </div>
                        </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative group/input">
                                    <input
                                        ...
                                        className="w-full bg-black/40 border border-slate-300 dark:border-white/10 rounded-2xl px-5 py-4 text-slate-900 dark:text-white font-medium focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500/40 transition-all outline-none appearance-none"
                                    />
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative group/input">
                                    <input
                                        ...
                                        className="w-full bg-black/40 border border-slate-300 dark:border-white/10 rounded-2xl px-5 py-4 text-slate-900 dark:text-white font-medium focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500/40 transition-all outline-none appearance-none"
                                    />
                        ...
                        <div className="mt-8 p-6 rounded-2xl bg-slate-50 dark:bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/5 space-y-4">
                             <div className="flex items-center gap-3">
                                <Activity className="w-4 h-4 text-emerald-500" />
                                <span className="text-[10px] font-black text-slate-900 dark:text-white uppercase tracking-widest">Active Enforcement Policy</span>
                             </div>
                    ...
                    {/* Compute Specs */}
                    <div className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm p-10 bg-slate-50 dark:bg-slate-100 dark:bg-white/5 border-slate-300 dark:border-white/10 group overflow-hidden relative transition-all duration-500 hover:bg-slate-100 dark:bg-slate-100 dark:bg-white/5 hover:border-slate-300 dark:border-white/20 lg:col-span-2">
                         ...
                         <div className="flex items-center gap-4 mb-10">
                            ...
                            <div>
                                <h2 className="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tight">Standard Instance Compute</h2>
                                <p className="text-xs text-slate-600 dark:text-slate-400 font-bold tracking-widest uppercase mt-1">Default Provisioning Profile</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            <div className="space-y-6">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-[14px] font-black text-slate-900 dark:text-white uppercase tracking-tight">{settings.cpu_limit_percent || 50}% Cores</span>
                                </div>
                                <input
                                    type="range"
                                    min="10"
                                    ...
                                    className="w-full h-2 bg-slate-100 dark:bg-white/5 rounded-full appearance-none cursor-pointer accent-rose-500"
                                />
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-[14px] font-black text-slate-900 dark:text-white uppercase tracking-tight">{settings.memory_limit_mb || 512} MB RAM</span>
                                </div>
                                <input
                                    type="range"
                                    min="128"
