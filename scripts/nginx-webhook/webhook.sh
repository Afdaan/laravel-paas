...
BASE_DOMAIN="${BASE_DOMAIN:-smkmuh1bantul.sch.id}"
NGINX_CONF_DIR="${NGINX_CONF_DIR:-/etc/nginx/conf.d/paas}"
ACME_EMAIL="${ACME_EMAIL:-admin@smkmuh1bantul.sch.id}"
WEBROOT="${WEBROOT:-/var/share/nginx/html}"
