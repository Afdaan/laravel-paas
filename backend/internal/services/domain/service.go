...
import (
	...
	projectPkg "github.com/laravel-paas/backend/internal/services/project"
	"gorm.io/gorm"
)
...
func NewDomainService(cfg *config.Config, db *gorm.DB, redisService *infrastructure.RedisService, projectService *projectPkg.ProjectService, projectRepo repositories.ProjectRepository) *DomainService {
